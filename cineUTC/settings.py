...
SECRET_KEY = 'django-insecure-@+y6qgc_5d*-=cp78j!1*glhnt!re@zp6xnk69fk%-w6pr#g3*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'cineutc-qstg.onrender.com').split(',')
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'javierguala07@gmail.com'
EMAIL_HOST_PASSWORD = 'jefo xlvq lylq vtoq'
